...
import {Form, Input, Tooltip, Icon, Select, Checkbox, Button, Modal, Radio, Cascader, DatePicker} from 'antd';
...
class RegisterForm extends React.Component {
    ...
    render() {
        ...
        return (
            <Form onSubmit={this.handleSubmit} className="register-form" style={{margin: 'auto'}}>
                <FormItem
                    {...formItemLayout}
                    label="login name"
                    hasFeedback
                >
                    {getFieldDecorator('loginname', {
                        rules: [{required: true, message: 'Please input your login name!', whitespace: true}],
                    })(
                        <Input />
                    )}
                </FormItem>
                ...
                >
                    {getFieldDecorator('gender', {
                        rules: [{required: true, message: 'Please tell your gender!', whitespace: true}],
                    })(
                        <Radio.Group>
